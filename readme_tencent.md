...
A library to simplify development of printing in apps on Android, as well as providing an improved user experience.  This library serves as an interface to HP Print Service plugin if the user has not installed one.
...
In order to improve the users' print experience, we have created a helper that guides users to the print plugin. See below:
![PluginHelper](https://s3-us-west-2.amazonaws.com/droidprint/images/plugin_helper_chn.png)
![Tencent](https://s3-us-west-2.amazonaws.com/droidprint/images/tencent.png)
